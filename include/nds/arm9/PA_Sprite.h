...
#define PA_OBJ_Y 255
#define OBJ_ROT 256
#define ALL_BUT_ROTSET 49663  // Num�ro du rotset
...
// M�moire gfx
typedef struct {
   u16 mem_block;  // Emplacement en m�moire, de 0 � 1023
   u16 free; // Doon�es libres en ce point
} mem_usage;

extern u16 n_free_mem[2]; // nombre d'emplacements libres
extern u8 used_mem[2][1024]; // Note la quantit� de m�moire utilis�e en chaque point de la m�moire pour pouvoir effacer les gfx...
extern u8 obj_per_gfx[2][1024]; // Nombre de sprites utilisant un gfx donn�...
...
extern obj_inf PA_obj[2][128] __attribute__ ((aligned (4)));  // Les 128 premiers pour l'�cran du haut, et encore 128 pour l'�cran du bas...

extern u8 PA_SpritePrio[2][128]; // Set the sprite priorities...

// Pour le dessin sur sprite
extern unsigned char *PA_SpriteBuffer[MAX_DRAW]; // Pointeurs vers les buffers  que l'on cr�era � la vol�e
...
/*! \def PA_UpdateOAM0()
    \brief
         ...
         \~french Mettre � jour les infos des sprites pour l'�cran 0 uniquement. A faire dans le VBL
*/
...
/*! \def PA_UpdateOAM1()
    \brief
         ...
         \~french Mettre � jour les infos des sprites pour l'�cran 1 uniquement. A faire dans le VBL
*/
...
/*! \fn void PA_UpdateOAM(void)
    \brief
         ...
         \~french Mettre � jour les infos des sprites pour les 2 �crans. A faire dans le VBL
*/
...
/*! \fn u16 PA_CreateGfx(u8 screen, void* obj_data, u8 obj_shape, u8 obj_size, u8 color_mode)
    \brief
         \~english Load in m�mory a gfx to use later on for a sprite. Returns the gfx's number in memory
         \~french Charger en m�moire un gfx � utiliser plus tard pour un sprite. Renvoie le num�ro en m�moire.
    \~\param screen
...
/*! \fn void PA_ResetSpriteSys(void)
    \brief
         ...
         \~french Remise � 0 du syst�me de sprite, de la m�moire...
*/
...
/*! \fn static inline void PA_Create16bitSpriteFromGfx(u8 screen, u8 obj_number, u16 gfx, u8 obj_shape, u8 obj_size, s16 x, s16 y)
    \brief
         ...
         \~french Creer un sprite de 16 bits � partir de gfx... 
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param obj_number
...
/*! \fn static inline void PA_UpdateGfx(u8 screen, u16 gfx_number, void *obj_data) 
    \brief
         ...
         \~french Mettre � jour les Gfx donn�s
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param gfx_number
...
/*! \fn static inline void PA_UpdateGfxAndMem(u8 screen, u8 gfx_number, void *obj_data)
    \brief
         ...
         \~french Mettre � jour les Gfx donn�s et le pointer d'animation dans PAlib... Uniquement pour utilisateurs avertis
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param gfx_number
...
static inline void PA_UpdateGfxAndMem(u8 screen, u8 gfx_number, void *obj_data){
	...
	PA_SpriteAnimP[screen][gfx_number] = (u16*)obj_data; // m�morise la source de l'image...
}
...
/*! \fn static inline void PA_Set16bitSpriteAlpha(u8 screen, u8 sprite, u8 alpha)
    ...
    \~\param sprite
         ...
         \~french Num�ro de l'objet dans le systeme de sprite, uniquement pour les sprites 16bit
    \~\param alpha
         \~english Alpha parameter, 0-15
         \~french Param�ter alpha, 0-15
*/
...
/*! \def PA_GetSpriteVflip(screen, obj)
    \brief
         ...
         \~french Si le flip vertical est utilis� ou non pour un sprite
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param obj
...
/*! \def PA_GetSpriteGfx(screen, obj)
    \brief
         ...
         \~french R�cup�rer le gfx utilis�s par un sprite
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param obj
...
/*! \def PA_GetSpritePrio(screen, obj)
    \brief
         ...
         \~french R�cup�rer la priorit� d'un sprite par rapport au Bg.
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param obj
...
/*! \def PA_GetSpriteLx(screen, sprite)
    \brief
         ...
         \~french R�cup�rer la largeur d'un sprite
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param sprite
...
/*! \def PA_GetSpriteLy(screen, sprite)
    \brief
         ...
         \~french R�cup�rer la hauteur d'un sprite
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param sprite
...
/*! \fn static inline u8 PA_GetSpritePixel(u8 screen, u8 sprite, u8 x, u8 y)
    \brief
         ...
         \~french R�cup�rer la couleur d'un pixel d'un sprite. Comme PA_GetSpritePixelEx, avec moins d'options, mais un peu plus lent
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param sprite
    ...
    \~\param x
         ...
         \~french Coordonn�e X du pixel
    \~\param y
         \~english Y coordinate of the pixel
         \~french Coordonn�e Y du pixel
*/
...
/*! \fn static inline u8 PA_GetSprite16cPixel(u8 screen, u8 sprite, u8 x, u8 y)
    \brief
         ...
         \~french R�cup�rer la couleur d'un pixel d'un sprite de 16 couleurs.
    \~\param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'�cran (0 ou 1)
    \~\param sprite
...
/*! \fn static inline void PA_InitAllSpriteDraw(void)
    \brief
         ...
         \~french Initialise tous les sprites � l'�cran pour dessiner dessus
*/
...
/*! \fn void PA_InitSpriteExtPrio(u8 SpritePrio)
    \brief
         ...
         \~french Activer le systeme de priorit� de sprites PAlib. Plus lent que le systeme normal, il permet d'avoir 256 niveaux de priorit� (supplante la priorit� par num�ro de sprites)
    \~\param SpritePrio
