...
/*! \def PA_DualLoadPal(palette, source)
    \brief
         ...
         \~french Charger une palette de 256 couleurs pour les fonds ou les sprites pour les 2 �crans
    \~\param palette
...
/*! \def PA_DualLoadPal16(palette, n_palette, source)
    \brief
         ...
         \~french Charger une palette de 16 couleurs pour les fonds ou les sprites pour les deux �crans
    \~\param palette
         \~english Set the Bg palette or Obj palette : PAL_BG or PAL_SPRITE
         \~french Charger pour les Bg ou les Sprites : PAL_BG ou PAL_SPRITE
    \~\param n_palette
         \~english Number of the 16 color palette to load (0-15)
         \~french Num�ro de la palette de 16 couleurs que l'on veut charger (0-15)
...
/*! \fn static inline void PA_DualSetPalNeg(u32 palette)
    \brief
         ...
         \~french N�gativer une palette donn�e. Pour annuler, il suffit de n�gativer � nouveau. 
    \~\param palette
...
static inline void PA_DualSetPalNeg(u32 palette) {
	...
	int i;
	for (i = 0; i < 256; i++) {
		pal[i+512] = pal[i] = ~pal[i]; // On fout le n�gatif...
	}
}
...
/*! \fn static inline void PA_DualSetPal16Neg(u32 palette, u8 n_palette)
    \brief
         ...
         \~french N�gativer une palette de 16 couleurs donn�e. Pour annuler, il suffit de n�gativer � nouveau. 
    \~\param palette
         \~english Set the Bg palette or Obj palette : PAL_BG, PAL_SPRITE
         \~french Charger pour les Bg ou les Sprites : PAL_BG, PAL_SPRITE
    \~\param n_palette
         \~english Number of the 16 color palette (0-15)
         \~french Num�ro de la palette de 16 couleurs (0-15)
*/
...
/*! \fn static inline void PA_DualLoadSpritePal(u8 palette_number, void* palette)
    ...
    \~\param palette
         ...
         \~french Nom de la palette � charger ((void*)nom_palette)
*/
...
/*! \fn static inline void PA_DualSetBgColor(u16 color)
    \brief
         ...
         \~french Changer la couleur de fond des 2 �crans
    \~\param color
